...
hausbesuch, zuzahlung, arzt_name, arzt_stempel_block
...
- leitsymptomatik: Welches der Kästchen ist angekreuzt? Mögliche Werte:
  ...
  (wenn das Kästchen rechts "patientenindividuelle Leitsymptomatik" angekreuzt ist),
  ODER "" wenn KEIN Leitsymptomatik-Kästchen angekreuzt ist.
...
def _api_call(content_bloecke: list) -> dict:
    ...
    logger.info("KI-Zuordnung OK (Modell %s, Bild-Modus)", MODELL)
    return felder
